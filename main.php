...
?>
<!-- Новинки -->
<?php $args = array('post_type' => 'tovar', 'posts_per_page' => 10);
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="title">
							...
							<div class="btm-style"><span><img src="<?php echo get_template_directory_uri(); ?>/images/btm-style.png" alt="" class="img-responsive"></span></div>
							<p class="bottom-p"><?php pll_e('Успей заказать с скидкой 50%'); ?><br><?php pll_e('предложение ограничено'); ?>!</p>
						</div>
					</div>
				</div>
				<div class="row">
								...
								<div class="blog-stl1">
									<div class="img-holder">
										...
										<div class="ovrl-block">
											<h3><?php the_title(); ?></h3>
											<a href="<?php the_permalink() ?>" class="btn1 stl2"><?php pll_e('Подробнее'); ?></a>
										</div>
